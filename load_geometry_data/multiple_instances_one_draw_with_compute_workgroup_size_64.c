...
int main(int argc, char *argv[]) {
  ...
  WGPUShaderModuleDescriptor computeShaderSource =
      load_wgsl(RESOURCE_DIR "compute_workgroup_size_64.wgsl");
...
#define PARTSIZE 64
  ...
  //IMPORTANT: the vertex shader still receives 0s for the values of excess vertices
  long numVertices = numVerticesMesh * numBs;
